class Superclass {
  ...
  // Ao mudar a visibilidade de _protected_ para _private_, o método `sayHello2` da _Subclass_ 
//   deixa de poder acessar o método `sayHello` definido na _Superclass_. Isso acontece 
//   pois um método privado só pode ser acessado na classe que o define.